import{m as $,g as M}from"./assets/header-Cs04khq2.js";import{a as u,d as T}from"./assets/vendor-oKrFQJru.js";const y="31537460e1a179eb456191c366c87865",b="https://api.themoviedb.org/3",L="https://image.tmdb.org/t/p/",w=document.getElementById("weekly-trends"),E=`<svg class="icon" id="stars-empty" width="18" height="18">
    ...
    `}).join(""),z()}function z(){const t=w,i=document.querySelectorAll(".movie-card");if(!i.length)return;t.classList.add("responsive-slider");let e=0,s;const n=i.length,r=i[0].offsetWidth,d=parseInt(window.getComputedStyle(i[0]).marginRight)||0,c=r+d;function m(o){e=(o+n)%n,t.scrollTo({left:e*c,behavior:"smooth"})}function p(){window.innerWidth<=768&&(clearInterval(s),s=setInterval(()=>{m(e+1)},5e3))}p(),window.addEventListener("resize",p);let a=0,g=0;t.addEventListener("touchstart",o=>{clearInterval(s),a=o.changedTouches[0].screenX},{passive:!0}),t.addEventListener("touchend",o=>{g=o.changedTouches[0].screenX,h(),p()},{passive:!0});function h(){g<a-50&&m(e+1),g>a+50&&m(e-1)}}const O=`
  <style>
