import"./assets/scroll-DYCuFZaQ.js";/* empty css                       */import{b as _}from"./assets/vendor-DogxyxdA.js";const m=new EventTarget,C=e=>{typeof e.genres=="string"&&(e.genres=e.genres.split(",").map(n=>({name:n.trim()})));const s=_.create(`
    <form id="movie-form">
