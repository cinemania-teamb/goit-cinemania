import"./assets/hero-io4eHbHz.js";/* empty css                       */import{b as w}from"./assets/vendor-DOPN71bB.js";const y=new EventTarget,C=e=>{typeof e.genres=="string"&&(e.genres=e.genres.split(",").map(n=>({name:n.trim()})));const r=w.create(`
    <form id="movie-form">
