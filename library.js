import{r as v}from"./assets/footer-modal-C_mnC_Kk.js";import{a as w,b as x}from"./assets/vendor-wG9nbpZs.js";const d=document.querySelector(".library-list");let s=document.querySelector(".load-more");const E="4e64f2e0a197aa7c5d1170773553320c";function y(){return JSON.parse(localStorage.getItem("movies"))||[]}let r=0;const g=9;document.getElementById("category").onchange=function(e){d.innerHTML="";const t=y(),n=e.target.value,i=[];if(t.forEach(o=>{o.genres.split(",").includes(n)&&i.push(o)}),i.length<=9)s.style.display="none",l(i);else{r=0;const o=i.slice(r,g);l(o);const p=s.cloneNode(!0);s.parentNode.replaceChild(p,s),s=document.querySelector(".load-more"),s.style.display="block",s.addEventListener("click",()=>{r+=9;const a=i.slice(r,r+g);if(a.length===0){s.style.display="none";return}l(a),r+g>=i.length&&(s.style.display="none")})}};function M(){const e=y();if(e.length===0){d.innerHTML=`<li class="empty-library">OOPS... We are very sorry! You don’t have any movies at your library.. <a href="./catolog.html" class="started">Get Started</a></li>
      
    `;return}if(e.length<=9)s.style.display="none",l(e);else{let t=0;const n=9,i=e.slice(t,n);l(i),s.style.display="block",s.addEventListener("click",()=>{t+=9;const o=e.slice(t,t+n);if(o.length===0){s.style.display="none";return}l(o),t+n>=e.length&&(s.style.display="none")})}}document.addEventListener("DOMContentLoaded",()=>{const e=window.location.pathname.split("/").pop()||"index.html";document.querySelectorAll(".nav-link").forEach(n=>{const i=n.getAttribute("href").split("/").pop();e===i?n.classList.add("active"):n.classList.remove("active")})});const l=e=>{const t=e.map(({id:n,title:i,poster_path:o,year:p,vote_average:a,genres:m})=>{const c=p.split("-")[0],u=v(Math.floor(a));return o&&`<li id="${n}" style="background-image: url(https://image.tmdb.org/t/p/w500/${o});background-size: cover;
