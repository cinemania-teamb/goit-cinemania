import"./assets/hero-GDhdec6J.js";/* empty css                       */import{b}from"./assets/vendor-DOPN71bB.js";const g=new EventTarget,$=e=>{typeof e.genres=="string"&&(e.genres=e.genres.split(",").map(a=>({name:a.trim()})));const r=b.create(`
    <form id="movie-form">
