import{r as h}from"./assets/loader-bIkT6TQI.js";import{a as w,b as x}from"./assets/vendor-oKrFQJru.js";const l=document.querySelector(".library-list"),i=document.querySelector(".load-more"),B="4e64f2e0a197aa7c5d1170773553320c";function v(){return JSON.parse(localStorage.getItem("movies"))||[]}let r=0;const p=9,M=()=>{const t=v();if(t.length===0){l.innerHTML='<li class="empty-library">OOPS... We are very sorry! You don’t have any movies at your library..</li>';return}if(t.length<9)i.style.display="none",m(t);else{const e=t.slice(r,p);m(e),i.style.display="block",i.addEventListener("click",()=>{r+=9;const o=t.slice(r,r+p);if(o.length===0){i.style.display="none";return}m(o),r+p>=t.length&&(i.style.display="none")})}},m=t=>{const e=t.map(({id:o,title:g,poster_path:n,year:u,vote_average:a,genres:c})=>{const s=u.split("-")[0],d=h(Math.floor(a));return n&&`<li id="${o}" style="background-image: url(https://image.tmdb.org/t/p/w500/${n});background-size: cover;
