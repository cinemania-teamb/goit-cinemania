import{r as L}from"./assets/footer-modal-C8nsbNFw.js";import{a as E,b as $}from"./assets/vendor-wG9nbpZs.js";const c=document.querySelector(".library-list"),l=document.querySelector(".load-more"),k=document.getElementById("category"),S="4e64f2e0a197aa7c5d1170773553320c";let r=0;const d=9;let p=[];function u(){return JSON.parse(localStorage.getItem("movies"))||[]}function v(e,t=!1){t&&(c.innerHTML="");const n=e.map(({id:o,title:i,poster_path:s,year:g,vote_average:a,genres:m})=>{const f=g.split("-")[0],b=L(Math.floor(a));return s&&`<li id="${o}" style="background-image: url(https://image.tmdb.org/t/p/w500/${s});background-size: cover;
