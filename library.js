import{r as v}from"./assets/header-D7gc00kA.js";import{a as w,b as x}from"./assets/vendor-wG9nbpZs.js";const d=document.querySelector(".library-list");let s=document.querySelector(".load-more");const E="4e64f2e0a197aa7c5d1170773553320c";function y(){return JSON.parse(localStorage.getItem("movies"))||[]}let r=0;const g=9;document.getElementById("category").onchange=function(e){d.innerHTML="";const t=y(),n=e.target.value,i=[];if(t.forEach(o=>{o.genres.split(",").includes(n)&&i.push(o)}),i.length<=9)s.style.display="none",l(i);else{r=0;const o=i.slice(r,g);l(o);const p=s.cloneNode(!0);s.parentNode.replaceChild(p,s),s=document.querySelector(".load-more"),s.style.display="block",s.addEventListener("click",()=>{r+=9;const a=i.slice(r,r+g);if(a.length===0){s.style.display="none";return}l(a),r+g>=i.length&&(s.style.display="none")})}};function M(){const e=y();if(e.length===0){d.innerHTML=`<li class="empty-library">OOPS... We are very sorry! You don’t have any movies at your library.. <a href="./catolog.html" class="started">Get Started</a></li>
